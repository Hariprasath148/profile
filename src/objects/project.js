...
export const projects = [
    ...
    {
        route : "cosmetics-ecommerce",
        name : "Cosmetics Ecommerce",
        siteLink : "https://www.figma.com/community/file/1519217104795206411",
        codeLink : "",
        img : cosmeticsEcommerceImg ,
        HeroImg : cosmeticsEcommerceHeroImg ,
        category : "UI/UX",
        short_discription : "A sleek and modern cosmetics eCommerce design focused on visual appeal and user-friendly navigation. It features high-quality imagery, personalized recommendations, and a seamless shopping experience across all devices.",
        long_discription : "This cosmetics eCommerce design is crafted to blend beauty with functionality. With a clean, modern layout, the interface highlights product visuals while ensuring effortless navigation for users. Key features include intuitive product filters, a personalized recommendation system, and a mobile-responsive layout. The product detail pages provide essential information such as ingredient lists, reviews, and tutorials to help users make informed decisions. The aesthetic uses soft tones, elegant typography, and minimalistic elements to reflect the sophistication of the beauty industry. The entire design is optimized to enhance user engagement and boost conversion rates through a frictionless shopping experience.",
        tech : {
            Figma : "Crafted in Figma, the design features a responsive UI with structured grid layouts, reusable components, and organized design systems."
        },
        keyPoints : [
            "Visually Rich Interface: Clean layout with high-resolution product imagery and subtle animations to highlight the beauty of each product.",
            "Product Filters & Categories: Intuitive filters (by brand, skin type, tone, ingredients, etc.) and smart categorization for easy browsing.",
            "Product Detail Page: Includes zoomable images, customer reviews, ingredient breakdowns, and usage instructions to build trust and drive conversions.",
            "Personalized Experience: “Recommended for You” and “Recently Viewed” sections based on browsing behavior.",
            "Mobile-First Design: Fully responsive layout optimized for smartphones and tablets to ensure accessibility on the go."
        ]
    },
    {
